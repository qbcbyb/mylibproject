...
import com.eric.library.commonutils.util.ShellUtils.CommandResult;

/**
 * PackageUtils
 * <ul>
 * <strong>Install package</strong>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#installNormal(android.content.Context, String)}</li>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#installSilent(android.content.Context, String)}</li>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#install(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#uninstallNormal(android.content.Context, String)}</li>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#uninstallSilent(android.content.Context, String)}</li>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#uninstall(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#isSystemApplication(android.content.Context)}</li>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#isSystemApplication(android.content.Context, String)}</li>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#isSystemApplication(android.content.pm.PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#getInstallLocation()} get system install location</li>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#isTopActivity(android.content.Context, String)} whether the app whost package's name is packageName is on the
 * top of the stack</li>
 * <li>{@link com.eric.library.commonutils.util.PackageUtils#startInstalledAppDetails(android.content.Context, String)} start InstalledAppDetails Activity</li>
 * </ul>
 * 
...
public class PackageUtils {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link com.eric.library.commonutils.util.PackageUtils#INSTALL_SUCCEEDED} means install success, other means failed. details see
     *         {@link com.eric.library.commonutils.util.PackageUtils}.INSTALL_FAILED_*. same to {@link android.content.pm.PackageManager}.INSTALL_*
