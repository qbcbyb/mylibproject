 ...
 * <li>{@link com.eric.library.commonutils.util.ViewUtils#getListViewHeightBasedOnChildren(android.widget.ListView)}</li>
 * <li>{@link com.eric.library.commonutils.util.ViewUtils#getAbsListViewHeightBasedOnChildren(android.widget.AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>set view height</strong>
 * <li>{@link com.eric.library.commonutils.util.ViewUtils#setViewHeight(android.view.View, int)} set view height</li>
 * <li>{@link com.eric.library.commonutils.util.ViewUtils#setListViewHeightBasedOnChildren(android.widget.ListView)}</li>
 * <li>{@link com.eric.library.commonutils.util.ViewUtils#setAbsListViewHeightBasedOnChildren(android.widget.AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>get other info</strong>
 * <li>{@link com.eric.library.commonutils.util.ViewUtils#getGridViewVerticalSpacing(android.widget.GridView)} get GridView vertical spacing</li>
 * </ul>
 * <ul>
 * <strong>set other info</strong>
 * <li>{@link com.eric.library.commonutils.util.ViewUtils#setSearchViewOnClickListener(android.view.View, android.view.View.OnClickListener)}</li>
 * </ul>
 * 
