...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see com.eric.library.commonutils.util.RandomUtils#getRandom(String source, int length)
     */
     ...
     *         <li>else see {@link com.eric.library.commonutils.util.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     *         </ul>
     */
