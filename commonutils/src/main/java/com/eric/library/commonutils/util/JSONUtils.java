...
public class JSONUtils {
     ...
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getLong(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see com.eric.library.commonutils.util.JSONUtils#getLong(org.json.JSONObject, String, Long)
     */
    public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see com.eric.library.commonutils.util.JSONUtils#getLong(String, String, Long)
     */
    public static long getLong(String jsonData, String key, long defaultValue) {
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getInt(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see com.eric.library.commonutils.util.JSONUtils#getInt(org.json.JSONObject, String, Integer)
     */
     ...
     * @param defaultValue
     * @return
     * @see com.eric.library.commonutils.util.JSONUtils#getInt(String, String, Integer)
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getDouble(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see com.eric.library.commonutils.util.JSONUtils#getDouble(org.json.JSONObject, String, Double)
     */
    public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see com.eric.library.commonutils.util.JSONUtils#getDouble(String, String, Double)
     */
    public static double getDouble(String jsonData, String key, double defaultValue) {
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getString(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getStringArray(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getStringList(org.json.JSONObject, String, java.util.List)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonData is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getJSONObject(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getJSONArray(org.json.JSONObject, String, org.json.JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link org.json.JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getBoolean(org.json.JSONObject, String, Boolean)}</li>
     *         </ul>
     */
     ...
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#parseKeyAndValueToMap(String)}</li>
     *         </ul>
     */
     ...
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#getMap(org.json.JSONObject, String)}</li>
     *         </ul>
     */
     ...
     *         <li>else parse entry by {@link com.eric.library.commonutils.util.MapUtils#putMapNotEmptyKey(java.util.Map, String, String)} one by one</li>
     *         </ul>
     */
     ...
     *         <li>return {@link com.eric.library.commonutils.util.JSONUtils#parseKeyAndValueToMap(org.json.JSONObject)}</li>
     *         </ul>
     */
