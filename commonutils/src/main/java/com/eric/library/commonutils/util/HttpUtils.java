 ...
 * <li>{@link #httpGet(HttpRequest, com.eric.library.commonutils.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * <li>{@link #httpGet(String, com.eric.library.commonutils.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * </ul>
 * <ul>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.eric.library.commonutils.util.HttpUtils#httpGet(HttpRequest)
     */
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.eric.library.commonutils.util.HttpUtils#httpPost(HttpRequest)
     */
     ...
     *        {@link com.eric.library.commonutils.util.HttpUtils#joinParas(java.util.Map)}
     * @return the content of the url, if null represents http error
     * @see com.eric.library.commonutils.util.HttpUtils#httpPost(HttpRequest)
     */
