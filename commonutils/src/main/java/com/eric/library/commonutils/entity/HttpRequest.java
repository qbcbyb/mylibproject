 ...
 * <li>{@link com.eric.library.commonutils.entity.HttpRequest#HttpRequest(String)}</li>
 * <li>{@link com.eric.library.commonutils.entity.HttpRequest#HttpRequest(String, java.util.Map)}</li>
 * </ul>
 * <ul>
