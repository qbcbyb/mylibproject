...
import com.eric.library.commonutils.util.ListUtils;
import com.eric.library.commonutils.util.ObjectUtils;
import com.eric.library.commonutils.util.SerializeUtils;
 ...
 * <li>{@link #setOnGetDataListener(com.eric.library.commonutils.service.impl.PreloadDataCache.OnGetDataListener)} set how to get data, this cache will get data and preload data
 * by it</li>
 ...
 * <li>{@link com.eric.library.commonutils.service.impl.SimpleCache#setValidTime(long)} set valid time of elements in cache, in mills</li>
 * <li>{@link com.eric.library.commonutils.service.impl.SimpleCache#saveCache(String, com.eric.library.commonutils.service.impl.SimpleCache)} save cache to a file</li>
 * </ul>
 * <ul>
...
public class PreloadDataCache<K, V> extends SimpleCache<K, V> {
     ...
     * @see com.eric.library.commonutils.service.impl.PreloadDataCache#get(Object)
     */
     ...
     * <li>call {@link com.eric.library.commonutils.service.impl.PreloadDataCache.OnGetDataListener#onGetData(Object)} to get data and wait for it finish</li>
     * </ul>
     * 
     * @param key
     * @return element if this cache contains the specified key, else get data realtime and wait for it
    ...
    /**
     * <ul>
     * <li>Maximum size of the cache is {@link com.eric.library.commonutils.service.impl.SimpleCache#DEFAULT_MAX_SIZE}</li>
     * <li>Elements of the cache will not invalid, can set by {@link com.eric.library.commonutils.service.impl.SimpleCache#setValidTime(long)}</li>
