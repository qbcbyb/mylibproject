...
public class ImageUtils {
     ...
     * @return
     * @see com.eric.library.commonutils.util.ImageUtils#getInputStreamFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see com.eric.library.commonutils.util.ImageUtils#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOut
     * @return
     * @see com.eric.library.commonutils.util.ImageUtils#getBitmapFromUrl(String, int, boolean)
     */
