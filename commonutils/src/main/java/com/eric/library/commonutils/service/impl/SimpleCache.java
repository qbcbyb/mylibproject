...
import com.eric.library.commonutils.service.Cache;
import com.eric.library.commonutils.service.CacheFullRemoveType;
import com.eric.library.commonutils.util.MapUtils;
 ...
 * <li>{@link #put(Object, com.eric.library.commonutils.entity.CacheObject)} or {@link #put(Object, Object)} put element</li>
 * <li>{@link #get(Object)} get element</li>
 * <li>{@link #loadCache(String)} restore cache from file</li>
 * <li>{@link #saveCache(String, com.eric.library.commonutils.service.impl.SimpleCache)} save cache to file</li>
 * </ul>
 * <ul>
...
public class SimpleCache<K, V> implements Cache<K, V>, Serializable {
     ...
     *        invalid. Rule of invalid see {@link #isExpired(com.eric.library.commonutils.entity.CacheObject)}
     */
     ...
     * 
     * @param key key
     * @param value data of {@link com.eric.library.commonutils.entity.CacheObject}
     * @return return null if cache is full and cannot remove one, else return the value be putted
     * @see com.eric.library.commonutils.service.impl.SimpleCache#put(Object, com.eric.library.commonutils.entity.CacheObject)
     */
    @Override
     ...
     * @param key
     * @return
     * @see com.eric.library.commonutils.service.impl.SimpleCache#isExpired(com.eric.library.commonutils.entity.CacheObject)
     */
     ...
     * <li>if {@link com.eric.library.commonutils.entity.CacheObject#isExpired()} is true and {@link com.eric.library.commonutils.entity.CacheObject#isForever()} is false, return true, else</li>
     * <li>if {@link com.eric.library.commonutils.entity.CacheObject#getEnterTime()} add {@link #getValidTime()} less than current time, return true</li>
     * <li>return false</li>
     * </ul>
     * 
     * @param obj
    ...
    /**
     * save cache to file, the data of {@link com.eric.library.commonutils.entity.CacheObject} should can be serializabled
     * 
     * @param <K>
     * @param <V>
     * @param filePath
