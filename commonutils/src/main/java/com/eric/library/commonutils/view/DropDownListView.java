package com.eric.library.commonutils.view;
...
import com.eric.library.commonutils.R;
 ...
 * before</li>
 * <li>{@link #setOnDropDownListener(com.eric.library.common.view.DropDownListView.OnDropDownListener)} set listener which will be excuted when drop down, but you
 ...
 * before</li>
 * <li>{@link #setOnBottomListener(android.view.View.OnClickListener)} set listener which will be excuted when scroll to bottom, but you
